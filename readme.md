...
Hardware Tester is a Flask-based application for testing and managing hardware devices such as valves, peripherals, and MQTT-connected devices. This application provides a robust interface for hardware interaction, configuration, and real-time monitoring, with a focus on usability and flexibility.
...
Node.js and npm (for front-end assets like Socket.IO, if applicable)
...
4. Set Up the Environment Variables Create a .env file in the root directory with the following:

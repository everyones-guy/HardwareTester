...
class Peripheral(db.Model):
    ...
    device_id = db.Column(db.Integer, db.ForeignKey("public.devices.id"), nullable=False, index=True)
    created_at = db.Column(db.DateTime, default=datetime.utcnow, nullable=False)
    updated_at = db.Column(db.DateTime, default=datetime.utcnow, onupdate=datetime.utcnow, nullable=False)
    created_by = db.Column(db.Integer, db.ForeignKey("public.users.id"), nullable=True)
    modified_by = db.Column(db.Integer, db.ForeignKey("public.users.id"), nullable=True)
...
class Controller(db.Model):
    ...
    firmware_version = db.Column(db.String(50), nullable=True)
    device_metadata = db.Column(db.JSON, nullable=True)
    device_id = db.Column(db.Integer, db.ForeignKey("public.devices.id"), nullable=True, index=True)
...
class Emulation(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    controller_id = db.Column(db.Integer, db.ForeignKey("public.controllers.id"), nullable=False, index=True)
    ...
    blueprint_id = db.Column(db.Integer, db.ForeignKey("public.blueprints.id"), nullable=False)
...
class DeviceFirmwareHistory(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    device_id = db.Column(db.Integer, db.ForeignKey("public.devices.id"), nullable=False)
    firmware_id = db.Column(db.Integer, db.ForeignKey("public.firmwares.id"), nullable=False)
    uploaded_at = db.Column(db.DateTime, default=datetime.utcnow, nullable=False)
    uploaded_by = db.Column(db.Integer, db.ForeignKey("public.users.id"), nullable=True)
